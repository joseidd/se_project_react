...
.catch(console.error);
  ...
  <div className="page__content"><Header handleAddClick={handleAddClick} weatherData={weatherData} />
  <Main weatherData={weatherData} handleCardClick={handleCardClick} /></div>  
...
<label htmlFor="name" className="modal__label">
            ...
            Image{" "}
            <input type="imageUrl" className="modal__input" id="imageUrl" placeholder="Image URL"/>
            </label>
